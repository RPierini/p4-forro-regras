action i0_qr7() {
   ...
   hdr.s1_qr7_d.v = hdr.s1_qr7_d.v + hdr.s1_qr7_e.v;
}

action i1_qr7() {
   hdr.s0_qr7_c.v = hdr.s0_qr7_c.v ^ hdr.s0_qr7_d.v;
   hdr.s1_qr7_c.v = hdr.s1_qr7_c.v ^ hdr.s1_qr7_d.v;
}

action i2_qr7() {
   hdr.s0_qr7_b.v = hdr.s0_qr7_b.v + hdr.s0_qr7_c.v;
   hdr.s1_qr7_b.v = hdr.s1_qr7_b.v + hdr.s1_qr7_c.v;
}

action i3_qr7() {
   hdr.s0_qr7_b.v = hdr.s0_qr7_b.v[21:0] ++ hdr.s0_qr7_b.v[31:22];
   hdr.s1_qr7_b.v = hdr.s1_qr7_b.v[21:0] ++ hdr.s1_qr7_b.v[31:22];
}
...
action i5_qr7() {
   ...
   hdr.s1_qr7_e.v = hdr.s1_qr7_e.v ^ hdr.s1_qr7_a.v;
}
...
action i7_qr7() {
   ...
   hdr.s1_qr7_d.v = hdr.s1_qr7_d.v[4:0] ++ hdr.s1_qr7_d.v[31:5];
}
