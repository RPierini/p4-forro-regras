action i0_add_values_forro(
   ...
   hdr.stream_cipher_s0.v4  = hdr.stream_cipher_s0.v4 + key1; //v1 = k1
   hdr.stream_cipher_s0.v8  = hdr.stream_cipher_s0.v8 + key2; //v2 = k2
   hdr.stream_cipher_s0.v12 = hdr.stream_cipher_s0.v12 + key3; //v3 = k3
   hdr.stream_cipher_s0.v13 = hdr.stream_cipher_s0.v13 + 0x0; //v4 = t0
   hdr.stream_cipher_s0.v1  = hdr.stream_cipher_s0.v1 + 0x0; //v5 = t1
   hdr.stream_cipher_s0.v5  = hdr.stream_cipher_s0.v5 + FORRO_C0; // v6 = C0
   hdr.stream_cipher_s0.v9  = hdr.stream_cipher_s0.v9 + FORRO_C1; //v7 = C1
   hdr.stream_cipher_s0.v10 = hdr.stream_cipher_s0.v10 + key4; //v8 = k4
   hdr.stream_cipher_s0.v14 = hdr.stream_cipher_s0.v14 + key5; //v9 = k5
   hdr.stream_cipher_s0.v2  = hdr.stream_cipher_s0.v2 + key6; //v10 = k6
   hdr.stream_cipher_s0.v6  = hdr.stream_cipher_s0.v6 + key7; // v11 = k7
   hdr.stream_cipher_s0.v7  = hdr.stream_cipher_s0.v7 + hdr.stream_nonce.n0; // v12 = n0
   hdr.stream_cipher_s0.v11 = hdr.stream_cipher_s0.v11 + hdr.stream_nonce.n1; //v13 = n1
   hdr.stream_cipher_s0.v15 = hdr.stream_cipher_s0.v15 + FORRO_C2; //v14 = C2
   hdr.stream_cipher_s0.v3  = hdr.stream_cipher_s0.v3 + FORRO_C3; //v15 = C3
...
action i1_cipher () {
   ...
   hdr.stream_payload_b0.v1  = hdr.stream_payload_b0.v1  ^ hdr.stream_cipher_s0.v4;
   hdr.stream_payload_b0.v2  = hdr.stream_payload_b0.v2  ^ hdr.stream_cipher_s0.v8;
   hdr.stream_payload_b0.v3  = hdr.stream_payload_b0.v3  ^ hdr.stream_cipher_s0.v12;
   hdr.stream_payload_b0.v4  = hdr.stream_payload_b0.v4  ^ hdr.stream_cipher_s0.v13;
   hdr.stream_payload_b0.v5  = hdr.stream_payload_b0.v5  ^ hdr.stream_cipher_s0.v1;
   hdr.stream_payload_b0.v6  = hdr.stream_payload_b0.v6  ^ hdr.stream_cipher_s0.v5;
   hdr.stream_payload_b0.v7  = hdr.stream_payload_b0.v7  ^ hdr.stream_cipher_s0.v9;
   hdr.stream_payload_b0.v8  = hdr.stream_payload_b0.v8  ^ hdr.stream_cipher_s0.v10;
   hdr.stream_payload_b0.v9  = hdr.stream_payload_b0.v9  ^ hdr.stream_cipher_s0.v14;
   hdr.stream_payload_b0.v10 = hdr.stream_payload_b0.v10 ^ hdr.stream_cipher_s0.v2;
   hdr.stream_payload_b0.v11 = hdr.stream_payload_b0.v11 ^ hdr.stream_cipher_s0.v6;
   hdr.stream_payload_b0.v12 = hdr.stream_payload_b0.v12 ^ hdr.stream_cipher_s0.v7;
   hdr.stream_payload_b0.v13 = hdr.stream_payload_b0.v13 ^ hdr.stream_cipher_s0.v11;
   hdr.stream_payload_b0.v14 = hdr.stream_payload_b0.v14 ^ hdr.stream_cipher_s0.v15;
   hdr.stream_payload_b0.v15 = hdr.stream_payload_b0.v15 ^ hdr.stream_cipher_s0.v3;
