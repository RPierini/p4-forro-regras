action i0_qr15() {
   ...
   hdr.s1_qr15_line0.d = hdr.s1_qr15_line0.d + hdr.s1_qr15_line0.e;
}

action i1_qr15() {
   hdr.s0_qr15_line0.c = hdr.s0_qr15_line0.c ^ hdr.s0_qr15_line0.d;
   hdr.s1_qr15_line0.c = hdr.s1_qr15_line0.c ^ hdr.s1_qr15_line0.d;
}

action i2_qr15() {
   hdr.s0_qr15_line0.b = hdr.s0_qr15_line0.b + hdr.s0_qr15_line0.c;
   hdr.s1_qr15_line0.b = hdr.s1_qr15_line0.b + hdr.s1_qr15_line0.c;
}

action i3_qr15() {
   hdr.s0_qr15_line0.b = hdr.s0_qr15_line0.b[21:0] ++ hdr.s0_qr15_line0.b[31:22];
   hdr.s1_qr15_line0.b = hdr.s1_qr15_line0.b[21:0] ++ hdr.s1_qr15_line0.b[31:22];
}

action i4_qr15() {
   hdr.s0_qr15_line0.a = hdr.s0_qr15_line0.a + hdr.s0_qr15_line0.b;
   hdr.s1_qr15_line0.a = hdr.s1_qr15_line0.a + hdr.s1_qr15_line0.b;
}

action i5_qr15() {
   hdr.s0_qr15_line0.e = hdr.s0_qr15_line0.e ^ hdr.s0_qr15_line0.a;
   hdr.s1_qr15_line0.e = hdr.s1_qr15_line0.e ^ hdr.s1_qr15_line0.a;
}
...
action i7_qr15() {
   ...
   hdr.s1_qr15_line0.d = hdr.s1_qr15_line0.d[4:0] ++ hdr.s1_qr15_line0.d[31:5];
}
